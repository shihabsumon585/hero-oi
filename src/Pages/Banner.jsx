    ...
    return (
        <div className='mt-10 space-y-4'>
            ...
            <div className='flex justify-center space-x-6'>
                <button className='btn'><img src={playStore} className='w-[25px]' alt="" /> Google Play</button>
                <button className='btn'><img src={appStore} className='w-[25px]' alt="" /> App Store</button>
            </div>
        </div>
    );
};
