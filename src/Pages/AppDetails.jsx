        ...
        <div className=''>
            <div className='pb-6 '>
                <div className='shadow mb-6 mt-4 border-b-1 border-gray-400 flex justify-baseline items-center gap-6 p-4 bg-white '>
                    <img className='rounded-2xl w-[300px]' src={singleAppData?.image} alt="" />
                    <div className='space-y-1 w-full'>
                        ...
                        <div className=''>
                            ...
                            <button onClick={handleInstall} className='btn btn-primary mt-6'>Install Now ({singleAppData?.size} MB)</button>
                        </div>
                    </div>
                </div>
